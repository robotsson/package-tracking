...
// import './components/PackageDetails.css';
...
//   const data = mockjsondata.find(p => p.parcel_id === parcel_id);
    ...
    <Router>
      <header className="App-header">
          <nav className="App-navigation">
            <Link className="App-link" to="/package-tracking/packages/">Packages</Link>&nbsp;
            <Link className="App-link" to="/package-tracking/details/testitem">Details</Link>&nbsp;
          </nav>
        <div className="App-title"><h1>Package Tracking</h1></div>

        <Routes>
          
          <Route path="/package-tracking/" element={<Packages/>} />
          <Route path="/package-tracking/packages/" element={<Packages/>} />
          <Route path="/package-tracking/details/" element={<PackageDetails/>} />
          <Route path="/package-tracking/details/:id" element={<PackageDetails/>} />
