...
function PackageDetailsWrapper() {
  ...
  if( parcel_id === "testitem" )
  {
      data = testItem;   
  }
  else
  {
      data = mockjsondata.find( p => p.parcel_id === parcel_id );  
  }
    ...
    <Router>
      <header className="App-header">
        ...
        <Routes>
          ...
          <Route path="/package-tracking/details/" element={<PackageDetailsWrapper/>} />
          <Route path="/package-tracking/details/:id" element={<PackageDetailsWrapper/>} />
